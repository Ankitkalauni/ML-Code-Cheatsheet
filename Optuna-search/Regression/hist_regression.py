...
# def fit_hist(trial, x_train, y_train, x_test, y_test):
#     params = {
...
#     model = HistGradientBoostingRegressor(**params,verbose=1000)
#     model.fit(x_train, y_train)
        
#     y_test_pred = model.predict(x_test)
#     log = {
#         "loss": mean_squared_error(y_test, y_test_pred, squared=False)}
...
#         model, log = fit_hist(trial, X_train, y_train, X_valid, y_valid)
#     _log += log['loss']
